#!/usr/bin/env python3
"""
Skrypt odświeżania codziennego cache z GitHub API dla repozytoriów AutoGrammar.
Uruchamiany automatycznie (np. przez GitHub Actions cron).
"""
...
def update_cache():
    ...
    print(f"[{now_iso}] Rozpoczynanie automatycznej synchronizacji cache dla {len(cache_data.get('projects', {}))} projektów AutoGrammar...")
